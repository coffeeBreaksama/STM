...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
	...
	LISTBOX_SetScrollbarWidth(hItem,50);
		...
		LISTBOX_SetSel(hItem,__configDataS.softAppType);
  ...
  case WM_NOTIFY_PARENT:
    ...
    case ID_BUTTON_SAVE: // Notifications sent by 'Save'
      ...
      case WM_NOTIFICATION_RELEASED:
		listSel = LISTBOX_GetSel(WM_GetDialogItem(pMsg->hWin, ID_LISTBOX_0));
		SYSTEM_Set_softAppType(listSel);
		SYSTEM_Set_showOpenPic(CHECKBOX_GetState(WM_GetDialogItem(pMsg->hWin, ID_CHECKBOX_0)));
...
*
*/
WM_HWIN SelectControlType(void);
WM_HWIN SelectControlType(void) {
...
unsigned int SETSYS_ICON4Clicked(void)
{
