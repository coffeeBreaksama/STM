...
static const char* prStringArray[][3] ={
	{"设置/增益系数 4","设置/增益系数 4","AmplifierCoe 4"},
...
static WM_HWIN AmplifierCoe4(void) {
	WM_HWIN hWin;
 	int i;
...
unsigned int RunFrmSysLoadCalAmplifierCoe4(void)
{

	__WindowsInfo[UI_GetWindowInfoIndexId(FORMID_AMP4)].FrmHandle = AmplifierCoe4();
	return 0xFF;
}
