...
static const char* prStringArray[][3] ={
	{"设置/增益系数 3","设置/增益系数 3","AmplifierCoe 3"},
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
	...
	sprintf(strBuffer,"%d",__sensorConfig.softAmplify[2]);
  ...
  case WM_NOTIFY_PARENT:
	...
	case ID_BUTTON_SAVE: // Notifications sent by 'SAVE'
      ...
      case WM_NOTIFICATION_RELEASED: 
		  ...
		  Sensor_Set_softAmplify(tempInt,2);
...
static WM_HWIN AmplifierCoe3(void) {
	WM_HWIN hWin;
 	int i;
...
unsigned int RunFrmSysLoadCalAmplifierCoe3(void)
{

	__WindowsInfo[UI_GetWindowInfoIndexId(FORMID_AMP3)].FrmHandle = AmplifierCoe3();
	return 0xFF;
}
