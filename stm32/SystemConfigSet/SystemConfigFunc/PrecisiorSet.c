...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  static char listSel = 0, EditBuffer;
  ...
  case WM_INIT_DIALOG:
	...
	LISTBOX_SetScrollbarWidth(hItem,50);
		...
		LISTBOX_SetSel(hItem,__emConfig.encodeCoe[0]);
...
unsigned int SETSYS_ICON8Clicked(void)
{
