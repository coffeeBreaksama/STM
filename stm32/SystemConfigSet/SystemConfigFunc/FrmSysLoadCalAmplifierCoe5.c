...
static const char* prStringArray[][3] ={
	{"设置/增益系数 5","设置/增益系数 5","AmplifierCoe 5"},
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
	...
	sprintf(strBuffer,"%d",__sensorConfig.softAmplify[3]);
  ...
  case WM_NOTIFY_PARENT:
	...
	case ID_BUTTON_SAVE: // Notifications sent by 'SAVE'
      ...
      case WM_NOTIFICATION_RELEASED: 
		  ...
		  Sensor_Set_softAmplify(tempInt,3);
...
static WM_HWIN AmplifierCoe5(void) {
	WM_HWIN hWin;
 	int i;
...
unsigned int RunFrmSysLoadCalAmplifierCoe5(void)
{

	__WindowsInfo[UI_GetWindowInfoIndexId(FORMID_AMP5)].FrmHandle = AmplifierCoe5();
	return 0xFF;
}
