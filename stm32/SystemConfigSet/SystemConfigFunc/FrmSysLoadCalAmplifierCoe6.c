...
static const char* prStringArray[][3] ={
	{"设置/增益系数 6","设置/增益系数 6","AmplifierCoe 6"},
...
static WM_HWIN AmplifierCoe6(void) {
	WM_HWIN hWin;
 	int i;
...
unsigned int RunFrmSysLoadCalAmplifierCoe6(void)
{

	__WindowsInfo[UI_GetWindowInfoIndexId(FORMID_AMP6)].FrmHandle = AmplifierCoe6();
	return 0xFF;
}
