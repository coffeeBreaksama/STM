...
static const char* prStringArray[][3] ={
	{"设置/增益系数 2","设置/增益系数 2","AmplifierCoe 2"},
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
	...
	sprintf(strBuffer,"%d",__sensorConfig.softAmplify[1]);
  ...
  case WM_NOTIFY_PARENT:
	...
	case ID_BUTTON_SAVE: // Notifications sent by 'SAVE'
      ...
      case WM_NOTIFICATION_RELEASED: 
		  ...
		  Sensor_Set_softAmplify(tempInt,1);
...
static WM_HWIN AmplifierCoe2(void) {
	WM_HWIN hWin;
 	int i;
...
unsigned int RunFrmSysLoadCalAmplifierCoe2(void)
{
	__WindowsInfo[UI_GetWindowInfoIndexId(FORMID_AMP2)].FrmHandle = AmplifierCoe2();
	return 0xFF;
}
