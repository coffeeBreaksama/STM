...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  ...
  { TEXT_CreateIndirect, "KN", ID_TEXT_UBEGIR, 380, 120, 120, 30, GUI_TA_LEFT | GUI_TA_TOP, 0x0, 0 },
  { TEXT_CreateIndirect, "%", ID_TEXT_UJUDGE, 380, 180, 120, 30, GUI_TA_LEFT | GUI_TA_TOP, 0x0, 0 },
  { TEXT_CreateIndirect, "%", ID_TEXT_ULOAD, 380, 240, 120, 30, GUI_TA_LEFT | GUI_TA_TOP, 0x0, 0 },
  ...
  case WM_NOTIFY_PARENT:
    ...
    case ID_BUTTON_SAVE: // Notifications sent by 'SAVE'
      ...
      case WM_NOTIFICATION_RELEASED:
		  ...
		  sec = atoi(strBuffer);
		  EditBuffer = hour*3600 + min*60 + sec;
		  USER_Set_fTimeStop(EditBuffer);
...
unsigned int SETUSER_ICON8Clicked(void)
{
