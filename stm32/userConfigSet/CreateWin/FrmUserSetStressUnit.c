...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
	...
	if(__configDataS.controlerType == 1 || __configDataS.controlerType == 3){
        if(__configDataU.testMethodLaOrYa <= 1) UI_SetListBoxTextByLgvg(hItem,_apListBox0,_apListBox0,_apListBox0);
        else UI_SetListBoxTextByLgvg(hItem,_apListBox1,_apListBox1,_apListBox1);
	}
	else if(__configDataS.controlerType == 3){
        UI_SetListBoxTextByLgvg(hItem,_apListBox1,_apListBox1,_apListBox1);
	}
	else{
         if(__configDataU.testMethodLaOrYa == 1 || __configDataU.testMethodLaOrYa == 5) UI_SetListBoxTextByLgvg(hItem,_apListBox1,_apListBox1,_apListBox1);
         else UI_SetListBoxTextByLgvg(hItem,_apListBox0,_apListBox0,_apListBox0);
	}
...
static WM_HWIN StressUion(void) {
...
unsigned int RunFrmUserSetStressUnit(void)
{
	...
	__WindowsInfo[UI_GetWindowInfoIndexId(FORMID_STRESSUNIT)].FrmHandle = StressUion();
	return 0xFF;
