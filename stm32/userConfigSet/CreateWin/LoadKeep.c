  ...
  case WM_NOTIFY_PARENT:
    ...
    case ID_BUTTON_SAVE: // Notifications sent by 'SAVE'
      ...
      case WM_NOTIFICATION_RELEASED:
		  ...
		  USER_Set_fTimeLoadKeep(EditBuffer);
...
static WM_HWIN LoadKeeping(void) {
  WM_HWIN hWin;
 	int i;
	for(i=0;i<=10;i++) strcpy(&__strBuf[i][0],prStringArray[i][__configDataU.languageSel]);
...
unsigned int SETUSER_ICON3Clicked(void)
{
