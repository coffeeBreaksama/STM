...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_NOTIFY_PARENT:
    ...
    NCode = pMsg->Data.v;
    switch(Id) {
    case ID_EDIT_Begin: // Notifications sent by 'Edit0'
      switch(NCode) {
      ...
      break;
    case ID_EDIT_Accel: // Notifications sent by 'Edit1'
      switch(NCode) {
      case WM_NOTIFICATION_CLICKED:
...
unsigned int SETUSER_ICON10Clicked(void)
{
