...
/*static const char*  _psStrTest[15][10] = {
	{"1倍,不反向",  "1倍,反向","2倍,不反向", "2倍,反向",NULL},
	{"1倍,不反向",  "1倍,反向","2倍,不反向", "2倍,反向",NULL},
	{"Zoom 1,No Reverse",  "Zoom 1,Reverse","Zoom 2,No Reverse","Zoom 2,Reverse",NULL}
};
*/
...
unsigned int SETUSER_ICON15Clicked(void)
{
