...
static void _setListTextOfTestType(WM_HWIN hList){
	...
	switch(__configDataS.softAppType){
		case 0:__SetListBoxTextAll(hList,_testTypeDis0_0,_testTypeDis0_1,_testTypeDis0_2);break;
		case 1:__SetListBoxTextAll(hList,_testTypeDis1_0,_testTypeDis1_1,_testTypeDis1_2);break;
		case 2:__SetListBoxTextAll(hList,_testTypeDis2_0,_testTypeDis2_1,_testTypeDis2_2);break;
		case 3:__SetListBoxTextAll(hList,_testTypeDis3_0,_testTypeDis3_1,_testTypeDis3_2);break;
		default: break;
	}
};
...
unsigned int SETUSER_ICON1Clicked(void)
{
