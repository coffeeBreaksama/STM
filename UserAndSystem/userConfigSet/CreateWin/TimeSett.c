...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  char strBuffer[30];
  char hour,min,sec,year,month,day;
  // USER END
...
unsigned int SETUSER_ICON17Clicked(void)
{
